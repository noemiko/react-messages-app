...
export default class ModalComponent extends PureComponent {
    ...
    _handleShare() {
        ...
        message =  `${title}\n\nPrzeczytaj więcej @\n${url}\n\nudostępnione przez Aplikację do wiadomości`
        return Share.share(
            ...
            return (
                <Modal onRequestClose={this._handleClose} visible={showModal} transparent animationType="slide">
                    <Container style={{margin:16,marginBottom:0,backgroundColor:'#ffffff'}}>
                        ...
                        <Content contentContainerStyle={{height:10000}}>
                            <WebView onError={this._handleClose} startInLoadingState scalesPageToFit={true} source={{uri:url}}/>
                        </Content>
                    </Container>
                </Modal>
            )
